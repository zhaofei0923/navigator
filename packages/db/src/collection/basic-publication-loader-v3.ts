...
import { BASIC_COLLECTION_AUDIT_V3_SCHEMA_VERSION } from "./basic-collection-v3-contracts.js";
...
import { parseBasicCountryPublicationManifestV3 } from "./basic-publication-parser.js";
import { validateApprovedBasicCountryPublicationV3 } from "./basic-publication-validator-v3.js";
...
const MANIFEST_INVALID: BasicCountryPublicationValidationResultV3 = Object.freeze({
  valid: false,
  blockerCode: "MANIFEST_INVALID",
  data: null,
});
const PUBLICATION_IDENTITY_MISMATCH: BasicCountryPublicationValidationResultV3 =
  Object.freeze({
    valid: false,
    blockerCode: "PUBLICATION_IDENTITY_MISMATCH",
    data: null,
  });
const PUBLICATION_READ_FAILED: BasicCountryPublicationValidationResultV3 = Object.freeze({
  valid: false,
...
export function loadApprovedBasicCountryPublicationV3(
  ...
  try {
    ...
    const manifestResult = parseBasicCountryPublicationManifestV3(
    ...
    return validateApprovedBasicCountryPublicationV3({
      countryDirectory,
