...
import type { BasicCountryPublicationManifestV3 } from "./basic-publication-contracts.js";
...
const MATERIALIZATION_ERROR = "Basic canonical v3 materialization failed";

export function materializeBasicCanonicalFromApprovedCandidateV3(
  candidate: BasicCollectionAuditBundleV3,
  manifest: BasicCountryPublicationManifestV3,
): BasicCanonicalData {
  try {
    const values = Object.fromEntries(COUNTRY_FACT_PATHS.map((fieldPath) => [
