...
- `p0_delivery_evidence.template.json`：schema v8逐项列出90项P0需求、125个P0页面、
  56个P0 API、89项产品测试、17项工程测试、11项ACC验收、9类非委员会签署授权、
  18项可复算非功能指标、1份不可变发布制品、5项发布能力及最终发布硬门，并要求
  证据反向声明其覆盖的稳定主题，指标、发布能力和最终批准同时绑定最终提交及同一
  制品SHA-256。关键任务与AI引用使用分子/分母复算，六类泄漏必须各有实际测试样本。
